...
def cli(index: Index,
    ...
    COLLECTION_SPECIFIERS may be either names of collections or paths on the filesystem
    """
    uiutil.init_logging()
...
def resolve_collections(collection_specifiers: Iterable[str]) -> List[Tuple[cs.Collection, str]]:
    """
    Resolve collection names or paths on the filesystem into Collection objects
